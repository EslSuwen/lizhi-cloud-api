...
*/
/**
 * User: lanxinghua Date: 2019/8/20 18:24 Desc: pair配对，提供方便方式来处理简单的键值对 java:Pair Apache Commons Vavr
 *//*
   ...
   public class PairTest {
     public static void main(String[] args) {
       ...
       // 不可变配对
       AbstractMap.SimpleImmutableEntry<String, String> immutableEntry =
