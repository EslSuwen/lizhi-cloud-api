package com.cqjtu.mock;

import com.alibaba.fastjson.JSON;
import com.cqjtu.modules.sys.dao.SysConfigDao;
...
import com.cqjtu.modules.sys.service.impl.SysConfigServiceImpl;
import org.easymock.*;
...
/**
 * User: lanxinghua Date: 2019/8/16 10:53 Desc: 步骤 1.生成mock接口 2.设置预期行为 3.将mock对象切换到replay状态 4.测试
 * 5.验证mock对象行为
 */
@RunWith(EasyMockRunner.class)
public class EasyMockTest extends EasyMockSupport {

  @TestSubject private ISysConfigService configService = new SysConfigServiceImpl();

  @Mock private SysConfigDao configDao;
