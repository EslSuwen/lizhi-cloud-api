...
/**
 * User: lanxinghua Date: 2019/8/16 11:00 Desc: MockMvc对系统Controller进行测试，对数据库增删改查结束后会还原数据库
 * spring-test 1.创建mockMvc 2.添加断言 3.添加结果处理器 4.得到MvcResult进行自定义断言
 */
public class ControllerTest extends BaseTest {
  ...
  public void test01() throws Exception {
    String responseString =
        this.mockMvc
            .perform(get("http://www.baidu.com").param("name", "lxh"))
            .andReturn()
            .getResponse()
            .getContentAsString();
  ...
  public void test02() throws Exception {
    MvcResult result =
        this.mockMvc
            .perform(
                MockMvcRequestBuilders.get("http://www.baidu.com")
                    .param("key", "value")
                    .header("key", "value"))
  ...
  public void test03() throws Exception {
    String responseString =
        this.mockMvc
            .perform(
                MockMvcRequestBuilders.post("http://www.baidu.com") // 请求路径
                    .param("key", "value") // 参数
