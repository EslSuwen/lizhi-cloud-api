...
import com.cqjtu.common.constants.ViewEnum;
import com.cqjtu.common.exception.BizException;
import com.cqjtu.common.utils.DateUtils;
import com.cqjtu.common.utils.IdGen;
import com.cqjtu.common.validator.Assert;
import com.cqjtu.modules.front.vo.FileVo;
...
public class FileController extends AbstractController {
  static final IdGen idGen = IdGen.get();
  ...
  public R createFile(
    ...
    if (CollectionUtils.isEmpty(fileList)) {
      ...
      for (FileEntity fileEntity : fileList) {
        if (fileEntity.getType().equals(FileEnum.FOLDER.getType())
            && fileEntity.getOriginalName().equals(file.getOriginalName())) {
          flag = false;
          break;
        }
      }
  ...
  public R deleteFileOrFolder(@RequestBody Long[] ids) {
    ...
    try {
      ...
      Map<Long /*fileId*/, FileEntity> fileEntityMap =
          files.stream().collect(Collectors.toMap(FileEntity::getId, e -> e));
      for (Long id : idList) {
