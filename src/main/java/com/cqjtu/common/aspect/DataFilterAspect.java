...
import com.cqjtu.modules.sys.service.ISysRoleDeptService;
...
public class DataFilterAspect {
  ...
  @Autowired private ISysRoleDeptService sysRoleDeptService;

  @Pointcut("@annotation(com.cqjtu.common.annotation.DataFilter)")
