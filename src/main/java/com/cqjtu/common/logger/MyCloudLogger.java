package com.cqjtu.common.logger;
...
/** User: lanxinghua Date: 2019/8/15 15:00 Desc: */
public class MyCloudLogger implements IMyLogger {
  ...
  public static void main(String[] args) {
    System.out.println(
        MessageFormatter.arrayFormat("hello 1:{} 2:{}", Lists.newArrayList(1, 2).toArray()));
  }
        ...
        case TRACE:
          {
            if (arguments == null || arguments.length == 0) {
              ...
              if (tag == null) {
                logger.trace(
                    appendTag(MessageFormatter.arrayFormat(format, arguments).getMessage()));
              } else {
                logger.trace(
                    appendTag(tag, MessageFormatter.arrayFormat(format, arguments).getMessage()));
              }
            }
            break;
          }
